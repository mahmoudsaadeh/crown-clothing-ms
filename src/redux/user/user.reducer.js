...
/*
    ...
    - When the App first initializes, there will be no state. When an actions gets fired, there gonna be no state, so we should set an initial state. (as in the default state in React)
